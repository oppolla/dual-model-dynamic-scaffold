...
class TemperamentConfig:
    ...
    randomization_factor: float = 0.05 # Add a small amount of random fluctuation to the score.
...
class TemperamentSystem:
    ...
    def update(self,
        ...
        target_score += random.uniform(-self.config.randomization_factor, self.config.randomization_factor)
